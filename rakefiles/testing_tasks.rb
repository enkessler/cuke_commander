namespace 'cuke_commander' do
  ...
  task :run_rspec_tests => [:clear_old_results] do # rubocop:disable Style/HashSyntax
    ...
    completed_process = CukeCommander::CukeCommanderHelper.run_command(['bundle', 'exec', 'rspec',
  ...
  task :run_cucumber_tests => [:clear_old_results] do # rubocop:disable Style/HashSyntax
    ...
    completed_process = CukeCommander::CukeCommanderHelper.run_command(%w[bundle exec cucumber])
  ...
  task :test_everything => [:clear_old_results] do # rubocop:disable Style/HashSyntax
    ...
    Rake::Task['cuke_commander:run_rspec_tests'].invoke
    Rake::Task['cuke_commander:run_cucumber_tests'].invoke
